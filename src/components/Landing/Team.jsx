    ...
    return (
        <div id="team" className='w-screen bg-white  p-2 md:p-5'>
            ...
            <div className="w-full h-full mt-2 flex gap-3 flex-col md:grid md:grid-cols-3">
                <TeamItem image={"/assets/team-2.jpg"} name={"David Krugger"} position={"C.E.O"} />
                <TeamItem image={"/assets/team-31.jpg"} name={"Japser Frake"} position={"Regional Manager U.S.A"} />
                <TeamItem image={"/assets/team-21.jpg"} name={"Fiona Alabaska"} position={"Marketing Director"} />
                <TeamItem image={"/assets/team-34.jpg"} name={"Felicia Braca"} position={"Finicial Adviser"} />
                <TeamItem image={"/assets/team-35.jpg"} name={"Alejandro Ramirez"} position={"Market Analysis Adviser"} />
